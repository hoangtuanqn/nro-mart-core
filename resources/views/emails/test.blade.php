...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Xin chào!</p>
            <p>Email này được gửi từ {{ config('app.name') }} để kiểm tra cấu hình email của hệ thống.</p>
        ...
        <div class="footer">
            <p>© {{ date('Y') }} {{ config_get('site_name', config('app.name')) }}. Tất cả quyền được bảo lưu.</p>
        </div>
    </div>
</body>
