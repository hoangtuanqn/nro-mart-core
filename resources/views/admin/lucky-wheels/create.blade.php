                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered config-table" id="configTable">
                                                            ...
                                                            <td>
                                                                <div class="input-group input-group-sm">
                                                                    <input type="number"
                                                                        ...
                                                                        required>
                                                                    <span
                                                                        class="input-group-text reward-symbol-{{ $i }}">Vàng</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="input-group input-group-sm">
